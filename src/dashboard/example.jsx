...
const Projects = () => {
  return (
    <div className="py-12 px-10 bg-gradient-to-l from-[#2234AE] from-0%  to-[#000000] to-40%  text-primary-content">
      <div className="mb-12">
        <h1 className="text-4xl  font-bold text-[#15803d] mb-4 underline underline-offset-8">Projects</h1>
        <p className="">I like exploring and learning new. I always build projects try out new tools and concepts.</p>
      </div>
      ...
      whileTap={{ scale: 0.9 }}>
        <div className="border border-gray-700 rounded-lg relative">
          <img className="w-full h-[350px]" src="https://i.ibb.co.com/nspYRvw/Screenshot-2024-12-06-005657.png" alt="" />
          <div className="absolute top-64 left-5">
          <div className="mt-4 flex items-center gap-3">
            <a href="https://github.com/msetu1/kester-soccer-club">
            <button className="border-2 border-[#15803d] px-6 py-2 lg:text-xl md:text-xl font-bold rounded-lg hover:bg-black flex items-center gap-3 bg-green-800 text-white ">Github <FaGithub/></button>
      ...
      whileTap={{ scale: 0.9 }}>
        <div className="border border-gray-700 rounded-lg relative">
          <img className="w-full h-[350px]" src="https://i.ibb.co.com/r3y2M1H/Screenshot-2024-12-06-005332.png" alt="" />
          <div className="absolute top-64 left-5">
          <div className="mt-4 flex items-center gap-3">
            <a href="https://github.com/msetu1/kester-soccer-club">
            <button className="border-2 border-[#15803d] px-6 py-2 lg:text-xl md:text-xl font-bold rounded-lg hover:bg-black flex items-center gap-3 bg-green-800 text-white ">Github <FaGithub/></button>
