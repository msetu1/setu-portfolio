...
const Details = () => {
    return (
        <div>
           ...
           <img className="w-[140px] rounded-full border-8 border-[#15803d] h-[140px]" src="https://i.ibb.co/gFCfLYK/setu-img-removebg-preview.png" alt="" />
           <div>
                <h1 className="text-3xl font-bold text-primary-content  mt-4 text-center">Mst.Setu Akther</h1>
